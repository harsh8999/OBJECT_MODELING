...
public class UserService implements IUserService {
    ...
    public UserRegistrationDto withdrawContest(String contestId, String userName) throws ContestNotFoundException, UserNotFoundException, InvalidOperationException {
        ...
        if(!user.checkIfContestExists(contest)){
            throw new InvalidOperationException("Cannot withdraw Contest. User "+userName+" is not is not registered in Contest for given id:"+contestId);
        }
        if(user.equals(contest.getCreator())) {
            throw new InvalidOperationException("Creator Can't withdraw from the contest!!!");
        }
